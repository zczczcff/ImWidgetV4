...
void ConfigureApplication(ImWidgetV4::ImApplication& application)
{
        ...
        application.SetApplicationIcon(application.GetCoreIconBrush(ImWidgetV4::ECoreIcon::Package, ImWidgetV4::FColor::FromFloat(0.484453f, 0.710807f, 0.993750f, 1.000000f)));
