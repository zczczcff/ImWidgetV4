...
TEST_F(TitleBarTest, FromJsonRelayoutsWhenSystemButtonsAreHidden)
{
    Advance();
    ...
    json serialized = TitleBar->ToJson();
    serialized["Properties"]["ImTitleBar::ShowSystemButtons"] = false;
    TitleBar->FromJson(serialized);
    Advance();
