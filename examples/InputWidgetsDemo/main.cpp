                   ...
                   LPSTR lpCmdLine, int nShowCmd)
{
    ...
    subtitle->SetText("CheckBox controls enabled state, EditableText reports live and committed text, Slider supports click, drag, and keyboard adjustment.");
    ...
    disableControls->SetLabel("Disable text box and slider");
    ...
    fillSampleButton->OnClicked.AddLambda([&](ImButton&) {
        editableText->SetText("Checkbox + EditableText + Slider");
