...
struct FHorizontalSplitterStyle {
    float BarWidth = 4.0f;
...
public:
    ...
    void SetSplitterStyle(const FHorizontalSplitterStyle& style) { m_Style = style; }
    const FHorizontalSplitterStyle& GetSplitterStyle() const { return m_Style; }
